...
export default function PodcastPromo() {
  return (
    <div className="bg-blue-50/80 border border-blue-200 rounded-2xl flex flex-col sm:flex-row items-center gap-4 sm:gap-6 px-5 py-4 mb-4 shadow hover:shadow-md transition animate-fade-in w-full">
