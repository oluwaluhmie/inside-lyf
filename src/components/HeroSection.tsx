...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-blue-100/50 via-purple-50/30 to-pink-50/50 rounded-3xl -rotate-1 scale-105"></div>
      ...
      <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl border border-white/50 shadow-2xl p-8 lg:p-12">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            <span className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-full text-sm font-semibold mb-4 animate-pulse">
              🔥 Over 50,000 stories shared this month
            </span>
            <h1 className="text-4xl lg:text-6xl font-black mb-4 leading-tight">
              Your Story
              <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent"> Matters</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 text-lg font-bold rounded-full hover:scale-105 transition-all shadow-lg hover:shadow-xl"
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-2 border-primary text-primary px-8 py-4 text-lg font-semibold rounded-full hover:scale-105 transition-all bg-white/50"
            >
