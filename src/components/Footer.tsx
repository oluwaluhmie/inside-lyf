          ...
          <div className="col-span-full md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md text-sm sm:text-base">
              ...
              <Link 
                ...
                className="inline-flex items-center gap-1 text-primary hover:text-primary/80 transition-colors group font-medium"
              >
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-6">
              <p className="text-gray-400 text-sm w-full sm:w-auto sm:text-center">Follow InsideLyf</p>
