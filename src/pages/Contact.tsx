    ...
    <div className="min-h-screen w-full flex flex-col bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/40">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-8 text-white text-center">
          ...
          <p className="mb-6">If you're experiencing a mental health crisis, please reach out for immediate support:</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div>
              <p className="font-bold text-lg">Emergency: 911</p>
              <p className="text-sm">Immediate danger</p>
            </div>
            <div>
              <p className="font-bold text-lg">Crisis Line: 988</p>
              <p className="text-sm">Suicide prevention</p>
            </div>
            <div>
              <p className="font-bold text-lg">Text: 741741</p>
