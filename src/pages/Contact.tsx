    ...
    <div className="min-h-screen w-full flex flex-col bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/40">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-8 text-white text-center">
          ...
          <p className="mb-6">If you're experiencing a mental health crisis or need emergency support, please visit our Safety Resources page for comprehensive emergency contacts and crisis support information.</p>
          <Link to="/safety">
            <Button variant="secondary" size="lg">
              View Safety Resources & Emergency Contacts
            </Button>
          </Link>
        </div>
      </main>
