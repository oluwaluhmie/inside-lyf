...
export default function AdminDashboard() {
  ...
  const availableTabs = [
    { key: 'overview', label: 'Overview', component: <StatsOverview userRole={userRole} /> },
    { key: 'posts', label: 'Posts', component: <PostManagement userRole={userRole} /> },
    { key: 'comments', label: 'Comments', component: <CommentManagement userRole={userRole} /> },
    { key: 'circles', label: 'Circles', component: <CircleManagement userRole={userRole} /> },
    { key: 'users', label: 'Users', component: <UserManagement userRole={userRole} /> },
    { key: 'profiles', label: 'Profiles', component: <UserProfileManagement userRole={userRole} /> },
    { key: 'analytics', label: 'Analytics', component: <Analytics userRole={userRole} /> },
    { key: 'premium', label: 'Premium', component: <PremiumManagement userRole={userRole} /> },
    { key: 'database', label: 'Database', component: <DatabaseManagement userRole={userRole} /> },
    { key: 'security', label: 'Security', component: <Security userRole={userRole} /> },
